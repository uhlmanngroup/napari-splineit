# -*- coding: utf-8 -*-
#
# napari-splineit2 documentation build configuration file, created by
...
project = u'napari-splineit2'
copyright = u'2015, Thorsten Beier'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-splineit2 Documentation',
     [author], 1)
]
